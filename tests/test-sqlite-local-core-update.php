...
$matching_update = (object) array(
	'current'  => '7.1.0',
	'download' => 'https://downloads.wordpress.org/release/wordpress-7.1.0.zip',
	'packages' => (object) array(
		'full'       => 'https://downloads.wordpress.org/release/wordpress-7.1.0.zip',
		'no_content' => 'https://downloads.wordpress.org/release/wordpress-7.1.0-no-content.zip',
...
$reinstall_update = (object) array(
	'current'  => '7.1.0',
	'download' => 'https://downloads.wordpress.org/release/wordpress-7.1.0.zip',
	'packages' => (object) array( 'full' => 'https://downloads.wordpress.org/release/wordpress-7.1.0.zip' ),
);
...
local_core_assert_same( 'https://downloads.wordpress.org/release/wordpress-7.1.0.zip', $disabled_filtered->updates[0]->packages->full, 'disabled integration leaves remote package untouched' );
putenv( 'WORDPRESS_LOCAL_CORE_UPDATE_ENABLED=true' );

$wp_version                  = '7.2.0';
$matching_update->download   = 'https://downloads.wordpress.org/release/wordpress-7.1.0.zip';
$matching_update->packages   = (object) array( 'full' => 'https://downloads.wordpress.org/release/wordpress-7.1.0.zip' );
$newer_installation_filtered = sqlite_wordpress_local_core_update_offer( (object) array( 'updates' => array( $matching_update ) ) );
local_core_assert_same( 'https://downloads.wordpress.org/release/wordpress-7.1.0.zip', $newer_installation_filtered->updates[0]->packages->full, 'newer WordPress is never downgraded' );
...
local_core_assert_same( 'https://downloads.wordpress.org/release/wordpress-7.1.0.zip', $invalid_filtered->updates[0]->packages->full, 'invalid local archive falls back to remote offer' );
