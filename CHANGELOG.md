...
- Added a disabled-by-default, token-protected `/tool-update-site-url.php`
  recovery page that atomically updates the WordPress `siteurl` and `home`
  options after a domain, scheme, port, or path change.
